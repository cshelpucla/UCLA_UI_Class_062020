...
class FormSurvey extends React.Component {
  ...
  componentDidMount() {
    //API.get('/getqa/test/14' )
   //.then(res => {    
    //  this.json = res.data;
     // this.model = new Survey.Model(res.data);              
                 
    //})
    // const myModel = new Survey.Model(this.json)   
  }
...
//const wrapper = document.getElementById("create-survey-form");
///wrapper ? ReactDOM.render(<FormSurvey />, wrapper) : false;
